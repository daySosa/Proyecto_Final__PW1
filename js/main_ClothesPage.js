...
function initRopaCatalog() {
  var grid = document.getElementById("ropaGrid");
  var filtersWrap = document.getElementById("ropaFilters");
  var paginationNav = document.getElementById("ropaPagination");
  var emptyMsg = document.getElementById("ropaEmpty");
